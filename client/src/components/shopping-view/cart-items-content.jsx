    ...
    <div className='flex items-center space-x-4'>
         ...
         <div className='flex-1'>
             ...
             <div className='flex items-center gap-2 mt-1'>
                ...
                variant ="outline" className="h-8 w-8 rounded-full" size="icon" disabled={cartItem?.quantity ===1 }>
         ...
         <div className='flex flex-col items-end'>
             ...
             <Trash  onClick={ () => handleCartItemDelete(cartItem)} className='cursor-poiinter mt-1' size={20} />
         </div>
    </div>
  )
}
